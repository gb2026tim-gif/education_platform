...
<div class="page">
	<div class="left">
		...
		<div class="content">
			...
			<div class="visual">
				<video src="/videos/login-robot.webm" autoplay loop muted playsinline class="robot-video"></video>
			</div>
...
<style>
	...
	.visual{display:flex;justify-content:center;align-items:center;margin-bottom:2.25rem;}
	.robot-video{width:min(370px,90%);border-radius:20px;}
	...
	.btn-primary{width:100%;background:#3E83FF;color:#fff;border:none;border-radius:10px;padding:0.9rem;font-size:0.95rem;font-weight:600;cursor:pointer;transition:background 0.2s;margin-top:0.25rem;font-family:inherit;}
