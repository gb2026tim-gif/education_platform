...
<div class="page">
	<div class="left">
		...
		<div class="content">
			<h1>Стань частиною<br/>спільноти майбутніх <br/><span style="color:#3E83FF">tech-лідерів</span></h1>
...
<style>
	...
	.right{flex:1;display:flex;align-items:center;justify-content:center;padding:2.5rem 3rem;background:#080e1c;border-left:1px solid rgba(255,255,255,0.04);overflow-y:auto;}
	.card{width:100%;max-width:600px;padding:1.5rem 0;}
	.card h2{font-size:1.75rem;font-weight:700;margin-bottom:0.5rem;}
	.sub{color:rgba(255,255,255,0.45);font-size:0.92rem;margin-bottom:1.85rem;}
	.error{background:rgba(239,68,68,0.12);border:1px solid rgba(239,68,68,0.25);color:#f87171;padding:0.8rem 1.1rem;border-radius:8px;font-size:0.9rem;margin-bottom:1.1rem;}
	.row{display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1rem;}
	.field{display:flex;flex-direction:column;}
	.field label{font-size:0.85rem;color:rgba(255,255,255,0.5);margin-bottom:0.45rem;}
	.field input{background:#111827;border:1px solid #1e2d45;border-radius:10px;padding:0.85rem 1.1rem;color:#fff;font-size:1.05rem;outline:none;transition:border-color 0.2s;box-sizing:border-box;min-width:0;width:100%;}
	...
	.agree-row{display:flex;align-items:flex-start;gap:0.65rem;margin-bottom:1rem;cursor:pointer;font-size:0.87rem;color:rgba(255,255,255,0.5);}
